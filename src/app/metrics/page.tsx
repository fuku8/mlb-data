...
const SECTIONS: MetricSection[] = [
  ...
  },
  {
    ...
    how: `規定打者（PA≥${HITTER_QUALIFY_PA}）のRBI分布からGini係数を算出（0=全員が完全に均等、1に近いほど偏りが大きい）。ローレンツ曲線は選手をRBIの少ない順に並べ、累積シェアをプロットしたもの。対角線（完全均等線）から離れるほど偏りが大きい。`,
    population: `規定打者（PA≥${HITTER_QUALIFY_PA}）。チーム内の規定打者が3人未満の場合はカード自体を非表示にしている。`,
