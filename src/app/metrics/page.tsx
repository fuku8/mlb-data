...
const SECTIONS: MetricSection[] = [
  ...
  },
  {
    ...
    how: "打者はBABIP（インプレー打球の安打率）とリーグ平均（規定打者プールの平均を自算）との差。±0.015未満は平年並み、±0.040以上はかなりの乖離。プラスは追い風=打球が平均より多くヒットになっている。投手はERAとFIP（三振・四球・被本塁打だけで測る「本当のERA」）の差。±0.30未満は平年並み、±0.70以上はかなりの乖離。ERAがFIPより悪い（差がプラス）と向かい風=実力より打たれて見えている。",
    population: `打者は規定打者（PA≥${HITTER_QUALIFY_PA}）、投手は規定投手（アウト数≥${PITCHER_QUALIFY_OUTS}）。母集団はLeague Percentile/セイバー指標カードと共通。`,
    caveat: "俊足や強い打球など実力でBABIPが高い選手もいるため、乖離のすべてが運ではない。判定文は控えめな可能性表現にとどめている。翌シーズンには平均に近づきやすい傾向はあるが、断定はできない。",
  },
  {
    id: "quadrant",
